...
import com.kalsym.ekedai.utility.*;
...
public class UserController {
    ...
    public ResponseEntity<HttpResponse> registerUser(
        ...
        if (userBody.getPhoneNumber() != null && userBody.getPassword() != null) {
            ...
            Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, logprefix, "User phone: ",
                    msisdn);
    ...
    public ResponseEntity<?> authenticateUser(
        ...
        Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, logprefix, "User Id: ",
                optUser.get().getId());
    ...
    public ResponseEntity<?> refreshToken(HttpServletRequest request,
        ...
        try {
            ...
            response.setStatus(HttpStatus.BAD_REQUEST, "Invalid token",
                    Integer.toString(HttpStatus.UNAUTHORIZED.value()));
            Logger.application.error(Logger.pattern, EkedaiApplication.VERSION, "refreshToken",
                    "Exception " + e.getMessage());
            return ResponseEntity.status(response.getStatus()).body(response);
        }
    ...
    public ResponseEntity<?> loginOauth(@RequestBody ValidateOauthRequest body,
        ...
        Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, logprefix, "body : ", body);
    ...
    public ResponseEntity<HttpResponse> sendRequest(HttpServletRequest request,
        ...
        try {
            ...
            response.setStatus(HttpStatus.OK);
            Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, logPrefix, "OTP SENT For : ",
                    msisdn);
    ...
    public ResponseEntity<HttpResponse> sendRegistrationOTPRequest(HttpServletRequest request,
        ...
        try {
            ...
            response.setData("SUCCESS");
            response.setStatus(HttpStatus.OK);
            Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, logPrefix, "OTP SENT To : ",
                    msisdn);
...
//        }
    ...
    private ExtraData extractExtraData(String extraData) {
        if (extraData == null) {
            Logger.application.info(Logger.pattern, EkedaiApplication.VERSION, "getAppUserToken", "No extra data");
        ...
        try {
            ...
            Logger.application.error(Logger.pattern, EkedaiApplication.VERSION, "getAppUserToken",
