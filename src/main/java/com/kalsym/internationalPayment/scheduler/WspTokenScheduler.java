...
public class WspTokenScheduler {
    ...
    public void checkAndRefreshToken() {
        ...
        if (InternationalPaymentApplication.WSPTOKENTIMEOUT == null) {
            return;
        }

        long bufferInSeconds = 5 * 60;
        long tokenTimeoutInSeconds =
                Long.parseLong(InternationalPaymentApplication.WSPTOKENTIMEOUT) - bufferInSeconds;
    ...
    private void fetchToken() {
        ...
        if (response.getStatusCodeValue() == 200) {
            ...
            InternationalPaymentApplication.WSPTOKEN = token;
            InternationalPaymentApplication.WSPTOKENTIMEOUT = tokenTimeOut;
        }
    }
}
