...
import com.kalsym.internationalPayment.repositories.DiscountWithDetailsRepository;
import com.kalsym.internationalPayment.services.CampaignService;
import com.kalsym.internationalPayment.services.DiscountProductVariantService;
import com.kalsym.internationalPayment.services.DiscountService;
import com.kalsym.internationalPayment.services.DiscountUserService;
...
public class DiscountController {
    ...
    public ResponseEntity<HttpResponse> getDiscountById(HttpServletRequest request,
        ...
        Logger.application.info(Logger.pattern, InternationalPaymentApplication.VERSION, logprefix, "Discount id: ", id);
    ...
    public ResponseEntity<HttpResponse> createDiscount(HttpServletRequest request,
        ...
        if (data.getDiscountCode() != null && data.getName() != null && data.getDiscountProductPage() != null) {
            ...
            Logger.application.info(Logger.pattern, InternationalPaymentApplication.VERSION, logprefix, "Discount Code: ",
    ...
    public ResponseEntity<HttpResponse> deleteDiscountProductVariant(HttpServletRequest request,
        ...
        if (data != null) {
            ...
            Logger.application.info(Logger.pattern, InternationalPaymentApplication.VERSION, logprefix, "Received Data: ", data);
