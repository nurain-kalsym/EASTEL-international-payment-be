...
import com.kalsym.internationalPayment.repositories.UserMergeRepository;
...
public class UserMergeService {
    ...
    public void processPendingMerges() {
        ...
        Logger.application.info(Logger.pattern, InternationalPaymentApplication.VERSION, "UserMergeScheduler", "Getting pending merges...");
